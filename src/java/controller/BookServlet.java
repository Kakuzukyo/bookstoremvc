...
public class BookServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("deleteButton") != null) {
            ...
            try {
                bookDAO.changeBook(itemId, title, image, price, summary, language, category, inventory, discount, description, authorId, publisherId);
            } catch (SQLException ex) {
                Logger.getLogger(BookServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            int publisherId = Integer.parseInt(request.getParameter("publisherId"));
            try {
                bookDAO.addBook(title, image, price, summary, language, category, inventory, discount, description, authorId, publisherId);
            } catch (SQLException ex) {
                Logger.getLogger(BookServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
